...
$current_question = isset($_GET['q'])
    ? (int) $_GET['q']
    : 0;

$quiz_query = mysqli_query(
    $conn,
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $_SESSION['answers'][$current_question]
        = $_POST['answer'] ?? '';
    ...
    if ($next_question < $total_questions) {
        ...
        header(
            "Location: take-quiz.php?id=$quiz_id&q=$next_question"
        );
